...
pub struct Materials { pub particle_material: Handle<ColorMaterial>}
...
pub fn spawn_particle(
    ...
    commands
        .spawn_bundle(SpriteBundle {
            ...
            transform: Transform::from_xyz(random::<f32>()*RANDOM_SPAWNER_MULTIPLIER,random::<f32>()*RANDOM_SPAWNER_MULTIPLIER,1.0),
            ..Default::default()
        })
        .insert(Particle {});
}
